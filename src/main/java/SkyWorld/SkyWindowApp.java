...
public class SkyWindowApp
{
    ...
    public static void main(String[] args){
        ...
        isRunning = true;
        mainFrame = new JFrame("光遇--by zbxzbx98");
        ...
        LonginButton.addActionListener(e ->
        {
            ...
            if (file.exists())
            {
                ...
                if (infos[8].equals(MD5.encode(new String(password.getPassword()))))
                {
                    ...
                    mainFrame.setTitle("光遇--by zbxzbx98--已登录：" + name);
//                    oldFrame.setEnabled(true);
        ...
        registerButton.addActionListener(e ->
        {
            if (!username.getText().isEmpty() && password.getPassword().length != 0)
            {
                ...
                you.save();
                f.dispatchEvent(new WindowEvent(f, WindowEvent.WINDOW_CLOSING));
                mainFrame.setTitle("光遇--by zbxzbx98--已登录：" + username.getText());
//                oldFrame.setEnabled(true);
                ToGame(oldLabel);
            }
            else
...
//        ImageIcon imageIcon = new ImageIcon(SkyWindowApp.class.getResource("/home.jpg"));
        ...
        JTextArea newTextDisplay = new JTextArea("光遇--by zbxzbx98\n");
//        newTextDisplay.setBounds(0,0,300, 300);
...
//        newInputField.setBounds(500, 350, 300, 100);
        ...
        you.nowMap = theMap;
        theMap.refreshMap();
        Thread choose = new Thread(()-> {while (isRunning) you.choose();});
        choose.start();
